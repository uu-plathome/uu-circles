import * as TestFunc from '@/lib/enum/api/CategorySlugProperty'

describe('Enum CategorySlugProperty', () => {
  it('isOfficialOrganization', () => {
    expect(TestFunc.CategorySlugProperty.official_organization).toBe('official_organization')
    expect(TestFunc.isCategorySlugProperty('official_organization')).toBeTruthy()
    expect(TestFunc.isOfficialOrganization('official_organization')).toBeTruthy()
    expect(TestFunc.isOfficialOrganization('aaaaabbbbcccc')).toBeFalsy()
  })
  it('isUnofficialOrganization', () => {
    expect(TestFunc.CategorySlugProperty.unofficial_organization).toBe('unofficial_organization')
    expect(TestFunc.isCategorySlugProperty('unofficial_organization')).toBeTruthy()
