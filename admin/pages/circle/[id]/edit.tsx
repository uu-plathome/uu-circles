    ...
    useEffect(() => {
        const f = async () => {
            ...
            if (foundCircle) {
                ...
                commonPlaceOfActivityDetail.set(
                    foundCircle.commonPlaceOfActivityDetail
                )
                commonDateOfActivityMonday.set(
                    foundCircle.commonDateOfActivityMonday
                )
                commonDateOfActivityTuesday.set(
                    foundCircle.commonDateOfActivityTuesday
                )
                ...
                commonDateOfActivityFriday.set(
                    foundCircle.commonDateOfActivityFriday
                )
                commonDateOfActivitySaturday.set(
                    foundCircle.commonDateOfActivitySaturday
                )
                commonDateOfActivitySunday.set(
                    foundCircle.commonDateOfActivitySunday
                )
                commonDateOfActivityDetail.set(
                    foundCircle.commonDateOfActivityDetail
                )
                isOnlineActivity.set(foundCircle.isOnlineActivity)
                onlinePlaceOfActivityDetail.set(
                    foundCircle.onlinePlaceOfActivityDetail
                )
                onlineDateOfActivityMonday.set(
                    foundCircle.onlineDateOfActivityMonday
                )
                onlineDateOfActivityTuesday.set(
                    foundCircle.onlineDateOfActivityTuesday
                )
                ...
                onlineDateOfActivityFriday.set(
                    foundCircle.onlineDateOfActivityFriday
                )
                onlineDateOfActivitySaturday.set(
                    foundCircle.onlineDateOfActivitySaturday
                )
                onlineDateOfActivitySunday.set(
                    foundCircle.onlineDateOfActivitySunday
                )
                onlineDateOfActivityDetail.set(
                    foundCircle.onlineDateOfActivityDetail
                )
                    ...
                    async success(result) {
                        try {
                            ...
                            switch (idx) {
                                case 1:
                                    if (
                                        isAdminPutStorageRequestValidationError(
                                            data
                                        )
                                    ) {
                                        activityImageUrl1.setErrors(
                                            data.errors.file
                                        )
                                    }
        ...
        if (!Array.isArray(id)) {
            const data = await updateCircle(Number(id), {
                ...
                commonDateOfActivityMonday:
                    commonDateOfActivityMonday.toBoolean,
                commonDateOfActivityTuesday:
                    commonDateOfActivityTuesday.toBoolean,
                commonDateOfActivityWednesday:
                    commonDateOfActivityWednesday.toBoolean,
                commonDateOfActivityThursday:
                    commonDateOfActivityThursday.toBoolean,
                commonDateOfActivityFriday:
                    commonDateOfActivityFriday.toBoolean,
                commonDateOfActivitySaturday:
                    commonDateOfActivitySaturday.toBoolean,
                commonDateOfActivitySunday:
                    commonDateOfActivitySunday.toBoolean,
                ...
                onlineDateOfActivityMonday:
                    onlineDateOfActivityMonday.toBoolean,
                onlineDateOfActivityTuesday:
                    onlineDateOfActivityTuesday.toBoolean,
                onlineDateOfActivityWednesday:
                    onlineDateOfActivityWednesday.toBoolean,
                onlineDateOfActivityThursday:
                    onlineDateOfActivityThursday.toBoolean,
                onlineDateOfActivityFriday:
                    onlineDateOfActivityFriday.toBoolean,
                onlineDateOfActivitySaturday:
                    onlineDateOfActivitySaturday.toBoolean,
                onlineDateOfActivitySunday:
                    onlineDateOfActivitySunday.toBoolean,
            ...
            if (isUpdateCircleFormRequestValidationError(data)) {
                ...
                commonPlaceOfActivity.setErrors(
                    data.errors.commonPlaceOfActivity
                )
