import * as TestFunc from '@/lib/enum/api/CircleType'

describe('Enum CircleType', () => {
  it('isOfficialOrganization', () => {
    expect(TestFunc.CircleType.OFFICIAL_ORGANIZATION).toBe('OFFICIAL_ORGANIZATION')
  ...
  it('isSendingOrganization', () => {
    expect(TestFunc.CircleType.SENDING_ORGANIZATION).toBe('SENDING_ORGANIZATION')
