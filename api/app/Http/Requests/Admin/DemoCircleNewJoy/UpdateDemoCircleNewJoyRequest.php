...
use App\Support\Arr;
use App\UseCases\AdminManagement\DemoCircleNewJoy\Params\UpdateDemoCircleNewJoyUsecaseParam;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Carbon;
use Illuminate\Support\Str;
use Illuminate\Validation\Rule;

class UpdateDemoCircleNewJoyRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return Arr::camel_keys([
            ...
            DemoCircleNewJoyProperty::place_of_activity_detail => ['string', 'nullable', 'max:255'],
    ...
    public function makeUpdateDemoCircleNewJoyUsecaseParam(): UpdateDemoCircleNewJoyUsecaseParam
    {
