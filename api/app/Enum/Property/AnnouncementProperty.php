...
class AnnouncementProperty
{
    ...
    const for_admin_mail = 'for_admin_mail';
    const for_newjoy_discord = 'for_newjoy_discord';
    const is_main_view_fixed = 'is_main_view_fixed';
    const is_circle_view_fixed = 'is_circle_view_fixed';
    const is_admin_view_fixed = 'is_admin_view_fixed';
