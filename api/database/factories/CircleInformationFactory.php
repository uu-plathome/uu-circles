...
$factory->define(CircleInformation::class, function (Faker $faker) {
    return [
        ...
        CircleInformationModel::common_date_of_activity_monday    => false,
        CircleInformationModel::common_date_of_activity_tuesday   => false,
        CircleInformationModel::common_date_of_activity_wednesday => true,
        CircleInformationModel::common_date_of_activity_thursday  => false,
        CircleInformationModel::common_date_of_activity_friday    => false,
        ...
        CircleInformationModel::online_date_of_activity_monday    => false,
        CircleInformationModel::online_date_of_activity_tuesday   => false,
        CircleInformationModel::online_date_of_activity_wednesday => true,
        CircleInformationModel::online_date_of_activity_thursday  => false,
        CircleInformationModel::online_date_of_activity_friday    => false,
