...
namespace Tests\Feature\App\Http\Requests\Circle;
...
class CirclePutStorageRequestTest extends TestCase
{
    use HasLang;
    ...
    {
        parent::setUp();
        Log::info("CirclePutStorageRequestTest");
    ...
    private function createRequest(): CirclePutStorageRequest
    {
        return new CirclePutStorageRequest();
    }
