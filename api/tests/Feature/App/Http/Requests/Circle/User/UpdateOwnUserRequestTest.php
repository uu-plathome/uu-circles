...
namespace Tests\Feature\App\Http\Requests\Circle\User;
...
class UpdateOwnUserRequestTest extends TestCase
{
    use HasLang;
    ...
    {
        parent::setUp();
        Log::info('UpdateOwnUserRequestTest');
    ...
    private function createRequest(): UpdateOwnUserRequest
    {
        return new UpdateOwnUserRequest();
    }
