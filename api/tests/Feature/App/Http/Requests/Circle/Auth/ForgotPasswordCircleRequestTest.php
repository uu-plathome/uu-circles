...
class ForgotPasswordCircleRequestTest extends TestCase
{
    use HasLang;
    ...
    private function createRequest(): ForgotPasswordCircleRequest
    {
        return new ForgotPasswordCircleRequest();
    }
