...
class VerificationResendCircleUserFormRequestTest extends TestCase
{
    use HasLang;
    ...
    {
        parent::setUp();
        Log::info('VerificationResendCircleUserFormRequestTest');
    ...
    private function createRequest(): VerificationResendCircleUserFormRequest
    {
        return new VerificationResendCircleUserFormRequest();
    }
