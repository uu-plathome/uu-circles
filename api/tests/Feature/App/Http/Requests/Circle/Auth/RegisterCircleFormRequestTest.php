...
class RegisterCircleFormRequestTest extends TestCase
{
    use HasLang;
    ...
    {
        parent::setUp();
        Log::info("RegisterCircleFormRequestTest");
    ...
    private function createRequest(): RegisterCircleFormRequest
    {
        return new RegisterCircleFormRequest();
    }
