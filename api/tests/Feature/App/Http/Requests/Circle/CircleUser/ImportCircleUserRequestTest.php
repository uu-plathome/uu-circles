...
class ImportCircleUserRequestTest extends TestCase
{
    use HasLang;
    ...
    {
        parent::setUp();
        Log::info('ImportCircleUserRequestTest');
    ...
    private function createRequest(): ImportCircleUserRequest
    {
        return new ImportCircleUserRequest();
    }
