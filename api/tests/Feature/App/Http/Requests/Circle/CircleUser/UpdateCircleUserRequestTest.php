...
class UpdateCircleUserRequestTest extends TestCase
{
    use HasLang;
    ...
    {
        parent::setUp();
        Log::info('UpdateCircleUserRequestTest');
    ...
    private function createRequest(): UpdateCircleUserRequest
    {
        return new UpdateCircleUserRequest();
    }
