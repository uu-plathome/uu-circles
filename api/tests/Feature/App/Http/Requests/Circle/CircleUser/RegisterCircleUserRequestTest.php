...
class RegisterCircleUserRequestTest extends TestCase
{
    use HasLang;
    ...
    {
        parent::setUp();
        Log::info('RegisterCircleUserRequestTest');
    ...
    private function createRequest(): RegisterCircleUserRequest
    {
        return new RegisterCircleUserRequest();
    }
