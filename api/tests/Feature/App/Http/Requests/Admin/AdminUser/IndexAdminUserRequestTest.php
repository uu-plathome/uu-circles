...
namespace Tests\Feature\App\Http\Requests\Admin\AdminUser;
...
class IndexAdminUserRequestTest extends TestCase
{
    use HasLang;
    ...
    {
        parent::setUp();
        Log::info('IndexAdminUserRequest');
    ...
    private function createRequest(): IndexAdminUserRequest
    {
        return new IndexAdminUserRequest();
    }
