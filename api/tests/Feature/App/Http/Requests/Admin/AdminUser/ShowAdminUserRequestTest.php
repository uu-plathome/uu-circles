...
class ShowAdminUserRequestTest extends TestCase
{
    use HasLang;
    ...
    private function createRequest(): ShowAdminUserRequest
    {
        return new ShowAdminUserRequest();
    }
