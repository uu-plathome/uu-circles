...
namespace Tests\Feature\App\Http\Requests\Admin\Announcement;
...
class CreateAnnouncementRequestTest extends TestCase
{
    use HasLang;
    ...
    {
        parent::setUp();
        Log::info("CreateAnnouncementRequestTest");
    ...
    private function createRequest(): CreateAnnouncementRequest
    {
