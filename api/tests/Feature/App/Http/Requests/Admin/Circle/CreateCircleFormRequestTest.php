...
namespace Tests\Feature\App\Http\Requests\Admin\Circle;
...
class CreateCircleFormRequestTest extends TestCase
{
    use HasLang;
    ...
    {
        parent::setUp();
        Log::info("CreateCircleFormRequestTest");
    ...
    private function createRequest(): CreateCircleFormRequest
    {
        return new CreateCircleFormRequest();
    }
