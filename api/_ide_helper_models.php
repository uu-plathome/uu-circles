...
namespace App\Models{
     ...
     * @property int|null                        $screen_width     画面の横幅
     * @property int|null                        $screen_height    画面の縦幅
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property-read \App\Models\Circle|null $circle
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|PagePositionHistory whereCircleId($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder|PagePositionHistory whereScreenHeight($value)
     * @method static \Illuminate\Database\Eloquent\Builder|PagePositionHistory whereScreenWidth($value)
