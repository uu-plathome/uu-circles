      ...
      <BaseLayout>
        <div className="px-6 pb-20 bg-gray-100">
          <BaseContainer>
            ...
            <Paragraph>
              この利用規約（以下，「本規約」といいます。）は，UU-PlatHome（以下，「当団体」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
            </Paragraph>
            ...
            <Section>
              ...
              <div className="text-right">
                <Paragraph>最終改訂日 2022年03月01日</Paragraph>
