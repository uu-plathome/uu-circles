    ...
    return (
        <div className="flex flex-col">
            <div className="relative text-gray-600">
                ...
                <p className="absolute right-0 top-0 mt-0.5 mr-2 md:mr-1 whitespace-nowrap text-black-900 px-1 md:px-2 flex items-center text-xs md:text-base" style={{ height: 34 }}>
                    <button type="submit">
