                ...
                <BaseContainer>
                    ...
                    {nowCircleNewJoys && nowCircleNewJoys.length > 0 ? (
                        <div className="pb-16">
                            ...
                            <IndexCircleNewJoyList slug={circle.slug} circleNewJoys={nowCircleNewJoys} />
                        </div>
                    ) : ''}
                    ...
                    <div className="pb-16">
                        ...
                        {todayCircleNewJoys && todayCircleNewJoys.length > 0 ? (
                            <IndexCircleNewJoyList slug={circle.slug} circleNewJoys={todayCircleNewJoys} />
                        ) : (
                            <p>今日の新歓はありません</p>
                        )}
                    </div>
                    ...
                    <div className="pb-16">
                        <h2 className="font-bold text-lg md:text-center pl-1 mb-3">開催予定</h2>
                        <IndexCircleNewJoyList slug={circle.slug} circleNewJoys={futureCircleNewJoys} />
                    </div>

                    <div className="pb-16">
                        <h2 className="font-bold text-lg md:text-center pl-1 mb-3">開催済み</h2>
                        <IndexCircleNewJoyList slug={circle.slug} circleNewJoys={pastCircleNewJoys} />
                    </div>

                    <div className="pb-16">
                        <Link href="/circle/[slug]" as={`/circle/${circle.slug}`}>
                            <a>
                                <h2 className="font-bold text-lg pl-1 mb-3">主催サークル</h2>
                                <div className="border border-4 border-gray-300 bg-white rounded-lg flex justify-between items-center px-2 py-2 mx-auto mb-2" style={{ width: 300 }}>
                                    ...
                                    <div className="w-full pr-2" style={{ width: 200 }}>
                                        <h3 className="text-black font-bold mb-1 text-sm font-bold">{ circle.name }</h3>
                                        <div>
