...
const Section: FunctionComponent = ({ children }) => <section className="my-8">{ children }</section>
const SubHeader: FunctionComponent = ({ children }) => <h2 className="text-lg mb-4">{ children }</h2>
const Paragraph: FunctionComponent = ({ children }) => <p className="text-sm mb-4">{ children }</p>
type ListProps = { 
    list: (string|Element)[]
}
const List: FunctionComponent<ListProps> = ({ list, children }) => {
    return (
        <ul className="text-sm list-decimal ml-8">
            {list.map((text, idx) => <li key={idx} className="mb-4">{ text }</li>)}
            ...
            <BaseLayout>
                <div className="bg-gray-100 px-2 pb-20">
                    <BaseContainer>
                        ...
                        <div>
                            <Paragraph>
                                U-lab（以下，「当団体」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
                            </Paragraph>
                            ...
                            <Section>
                                ...
                                >
                                    <div>
                                        <Paragraph>予め次の事項を告知あるいは公表し，かつ当団体が個人情報保護委員会に届出をしたとき</Paragraph>
                                        <List
                                            list={[
                                                '利用目的に第三者への提供を含むこと',
                                                '第三者に提供されるデータの項目',
                            ...
                            <Section>
                                ...
                                <Paragraph>本ポリシーに関するお問い合わせは，下記のお問い合わせまでお願いいたします。</Paragraph>
                                <Paragraph>
                                リンク：<a className="text-blue-500 underline" href="https://forms.gle/1oULcDjiPaknvfvc8">https://forms.gle/1oULcDjiPaknvfvc8</a>
                                </Paragraph>
